...
public class Game implements Runnable
{
    ...
    private static Game instance = null;//singura instanta a jocului

    ///Available states
    private State playState;            /*!< Referinta catre joc.*/
    private State menuState;            /*!< Referinta catre menu.*/
    private State highScoreState;        /*!< Referinta catre setari.*/
    private State aboutState;           /*!< Referinta catre about.*/
    private State pauseState;           /*!< Referinta catre meniul de pauza*/
...
//        wnd.GetWndFrame().addKeyListener(keyManager);
        ...
        /// Starea implicita de intrare in joc este cea de meniu
    }
    ...
    /*! \fn public GameWindow GetGameWindow()
        \brief Retureneaza proprietatile ferestrei jocului. Necesar pt a accesa Frame-ul
     */
    public GameWindow GetGameWindow(){return wnd;}

    public State GetMenuState(){return menuState;}

    public State GetPlayState(){return playState;}

    public void SetPlayState(State playState){this.playState = playState;}
    ...
    public void SetWinState(State winState){this.winState = winState;}
