...
{
    private Game game;          /*!< Referinta catre obiectul Game.*/       /*!< Referinta catre harta curenta.*/
    ...
    // Adăugăm getter/setter pentru LevelManager
    ...
    //public Hero GetHero(){ return ((PlayState)game.GetPlayState()).GetHero();}
